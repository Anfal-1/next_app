...
const translations = {
  ar: {
    // Dashboard
    "dashboard.title": "لوحة معلومات إي-تريك | منطقة القصيم",
    ...
    // Homepage
    "home.hero.title": "إي-تريك: المراقبة البيئية الذكية لمنطقة القصيم",
    "home.hero.subtitle":
    ...
    "home.features.cards.risk.description": "تحديد وتقييم المخاطر البيئية المحتملة مثل التصحر والجفاف وتدهور الأراضي.",
    ...
    // Footer
    "footer.description": "منصة متكاملة لمراقبة وتحليل البيانات البيئية في منطقة القصيم.",
    ...
    "tree.requiresAttention": "يتطلب اهتمامًا فوريًا. صحة الأشجار ضعيفة مع مخاطر محتملة على معدل البقاء.",
    ...
    "spi.subtitle": "يقيس ظروف الجفاف: القيم السالبة تشير إلى الجفاف، والقيم الموجبة تشير إلى ظروف رطبة",
    ...
    "soil.detailedData": "بيانات تفصيلية عن التآكل عبر مناطق مختلفة (طن/هكتار/سنة)",
    ...
    "ai.note": "ملاحظة:",
    "ai.imageRequirements": "يجب أن تكون الصور بدقة عالية وبتنسيق TIF/TIFF للحصول على أفضل النتائج.",
    "ai.invalidFileType": "نوع الملف غير صالح. يرجى اختيار ملف بتنسيق TIF أو TIFF.",
    ...
    "ai.processingError": "حدث خطأ أثناء معالجة الصورة. يرجى المحاولة مرة أخرى.",
    ...
    "ai.visualizationDescription": "تظهر الصورة المعالجة مناطق مختلفة مصنفة حسب حالة الغطاء النباتي ومستويات التصحر.",
    ...
    "ai.recommendationsDescription": "بناءً على تحليل البيانات، يقترح نظام الذكاء الاصطناعي الإجراءات التالية:",
    ...
    "ai.shareLinkDescription": "يمكنك الآن مشاركة نتائج التحليل مع الآخرين باستخدام الرابط المنسوخ.",
    "ai.riskLow": "منخفض",
    "ai.riskMedium": "متوسط",
    "ai.riskHigh": "مرتفع",
    "ai.riskCritical": "حرج",
    "ai.riskDescription.low": "مستوى منخفض من مخاطر التصحر. يوصى بالمراقبة المستمرة.",
    "ai.riskDescription.medium": "مستوى متوسط من مخاطر التصحر. يجب اتخاذ إجراءات وقائية.",
    "ai.riskDescription.high": "مستوى مرتفع من مخاطر التصحر. يتطلب تدخلاً فوريًا.",
    "ai.riskDescription.critical": "مستوى حرج من مخاطر التصحر. يتطلب تدخلاً فوريًا وشاملاً.",
  ...
  en: {
    // Dashboard
    "dashboard.title": "E-Trek Dashboard | Al-Qassim Region",
    ...
    "dashboard.exportCompleteDesc": "Your dashboard has been exported successfully.",

    // Navbar
    "nav.home": "Home",
    "nav.dashboard": "Dashboard",
    "nav.reports": "Environmental Reports",
    "nav.faq": "FAQ",

    // Homepage
    "home.hero.title": "E-Trek: Smart Environmental Monitoring for Al-Qassim",
    "home.hero.subtitle":
      "An integrated platform for monitoring and analyzing environmental data in the Al-Qassim region, helping make sustainable decisions and protect natural resources.",
    ...
    // Footer
    "footer.description":
      "An integrated platform for monitoring and analyzing environmental data in the Al-Qassim region.",
    ...
    "sidebar.subtitle": "Environmental Monitoring System for Al-Qassim Region",
    ...
    "tree.geoDistribution": "Geographic distribution of tree planting initiatives",
    ...
    "desert.low": "Low",
    "desert.satelliteComparison": "Satellite imagery comparison would be displayed here.",
    "desert.showingProgression": "Showing desertification progression from 2018 to 2022.",
    ...
    "soil.detailedData": "Detailed erosion data across different regions (t/ha/year)",
    ...
    "ai.note": "Note:",
    "ai.imageRequirements": "Images should be high-resolution and in TIF/TIFF format for best results.",
    "ai.invalidFileType": "Invalid file type. Please select a TIF or TIFF file.",
    "ai.removeFile": "Remove File",
    "ai.analysisOptions": "Analysis Options",
    "ai.selectTask": "Select Task Type",
    "ai.desertificationAnalysis": "Desertification Analysis from Satellite Image",
    ...
    "ai.processingError": "An error occurred while processing the image. Please try again.",
    ...
    "ai.recommendationsDescription": "Based on the data analysis, the AI system suggests the following actions:",
    ...
    "ai.shareLinkDescription": "You can now share the analysis results with others using the copied link.",
    "ai.riskLow": "Low",
    "ai.riskMedium": "Medium",
    "ai.riskHigh": "High",
    "ai.riskCritical": "Critical",
    "ai.riskDescription.low": "Low level of desertification risk. Continued monitoring recommended.",
    "ai.riskDescription.medium": "Medium level of desertification risk. Preventive measures should be taken.",
    "ai.riskDescription.high": "High level of desertification risk. Requires immediate intervention.",
