  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <div className="relative w-full h-64">
        <Image
          src="/map-banner.jpg" // غيّرها لصورة جوية للقصيم أو خريطة
      ...
      <div className="max-w-4xl mx-auto py-12 px-6 space-y-12">
        <section>
          ...
          <p className="mt-2 text-lg">
            E-Trek is an AI-powered geospatial platform built for monitoring
            vegetation health, combating desertification, and supporting
            sustainable afforestation in Al-Qassim, Saudi Arabia. It uses
            satellite imagery, drone data, and real-time analysis to empower
        ...
        <div className="pt-8 border-t text-center text-sm text-gray-600">
          Made with purpose | E-Trek Project © 2025
        </div>
      </div>
    </div>
  )
