  ...
  return (
    <div className="flex min-h-screen flex-col bg-green-50 dark:bg-gray-900">
      ...
      <main className="flex-1">
        {/* Hero Section بدون صورة، بلون فاتح */}
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-emerald-100">
          <div className="relative z-20 text-center px-6 max-w-3xl">
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              <Button
                asChild
                size="lg"
                className="bg-green-800 text-white hover:bg-green-900 transition"
              >
              ...
              <Button
                asChild
                size="lg"
                className="bg-white text-green-800 border border-green-800 hover:bg-green-100 transition"
              >
