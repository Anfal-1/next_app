  ...
  return (
    <div className="flex min-h-screen flex-col bg-green-50 dark:bg-gray-900">
      ...
      <main className="flex-1">
        <section className="relative h-screen flex items-center justify-center bg-gradient-to-l from-white to-green-100 px-4">
          <div className="max-w-2xl text-center space-y-10 animate-fade-in">
            <h1 className="text-4xl md:text-5xl font-bold leading-snug text-transparent bg-clip-text bg-gradient-to-r from-green-700 to-green-400">
              {t('home.hero.title')}
            </h1>

            <p className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-green-300 text-lg">
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              <Button
                asChild
                size="lg"
                className="bg-green-700 text-white hover:bg-green-800 transition duration-300"
              >
              ...
              <Button
                asChild
                size="lg"
                className="bg-white text-green-800 border border-green-700 hover:bg-green-100 transition duration-300"
              >
