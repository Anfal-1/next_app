  ...
  return (
    <div className="flex min-h-screen flex-col bg-green-50 dark:bg-gray-900">
      ...
      <main className="flex-1">
        <section className="relative h-screen flex items-center justify-center bg-gradient-to-b from-white to-green-100 px-4">
          <div className="max-w-2xl text-center space-y-10">
            <h1 className="text-4xl md:text-5xl font-bold text-green-900 leading-snug">
              {t('home.hero.title')}
            </h1>

            <p className="text-green-800">{t('home.hero.description')}</p>
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              ...
              <Button
                asChild
                size="lg"
                className="bg-white text-green-800 border border-green-700 hover:bg-green-100"
              >
