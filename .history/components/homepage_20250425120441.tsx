      ...
      <main className="flex-1">
        <section className="bg-white py-16 px-6">
          <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
            {/* النص يسار */}
            <div className="lg:w-1/2 text-center lg:text-le">
            ...
            <div className="lg:w-1/2 flex justify-center relative">
              {/* الإطار العلوي يمين */}
              <div className="absolute -top-1 -right-1 w-56 h-56 outline outline-1 outline-amber-800 rounded hidden lg:block z-0"></div>

              {/* الإطار السفلي يسار */}
              <div className="absolute -bottom-1 -left-1 w-56 h-56 outline outline-1 outline-amber-800 rounded hidden lg:block z-0"></div>
