      ...
      <main className="flex-1">
        <section className="relative h-screen flex items-center justify-center bg-gradient-to-l from-white to-green-100 px-4">
          <div className="max-w-2xl text-center space-y-10 animate-fade-in">
            <h1 className="text-4xl md:text-5xl font-bold leading-snug text-transparent bg-clip-text bg-gradient-to-l from-green-600 to-white">
              {t('home.hero.title')}
            </h1>

            <p className="text-transparent bg-clip-text bg-gradient-to-l from-green-500 to-white text-lg">
