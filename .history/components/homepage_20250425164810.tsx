      ...
      <main className="flex-1">
        ...
        <section className="bg-white py-16 px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 place-items-center">
            <Image
              src="/58E7D26A-48D1-4845-8246-6BEF4C851678.jpg"
              alt="Feature1"
              width={400}
              height={300}
            ...
            />
            <Image
              src="/FB19BBB3-3B99-413A-AE27-2FFDCF745C10.jpg"
              alt="Feature2"
              width={400}
              height={300}
              className="rounded shadow"
            />
            <Image
              src="/DDE6394B-D713-4792-8DAA-953B14EDD971.jpg"
              alt="Feature3"
              width={400}
              height={300}
              className="rounded shadow"
            />
            <Image
              src="/9533B02F-06D9-4DCC-8251-B5688C135EC4.jpg"
              alt="Feature4"
              width={400}
              height={300}
              className="rounded shadow"
