              ...
              <div className="max-w-4xl mx-auto space-y-10">
                ...
                <div className="text-center space-y-4">
                  <h2 className="text-3xl md:text-4xl font-bold text-green-800">
                    دعوتنا مفتوحة للتعاون والمقترحات
                  </h2>
                  <p className="text-green-700 leading-relaxed text-lg">
                    يتيح لكم مشروع <span className="font-semibold">E-Trek</span>{' '}
                    فرصة المساهمة في تطوير منظومة بيئية ذكية، تعتمد على تحليل
                    البيانات البيئية وعلوم الاستشعار عن بعد لتعزيز التشجير
                    ومراقبة الغطاء النباتي في منطقة القصيم.
                    <br />
                    نرحب بتواصلكم من الجهات المختصة، الباحثين، والمؤسسات التي
                    تسعى لتوظيف الذكاء الاصطناعي والبيانات المفتوحة لخدمة
                    الاستدامة.
                  </p>
                </div>

                {/* نموذج التواصل */}
                <form className="bg-white p-8 rounded-xl shadow-md border border-green-100 space-y-6 max-w-2xl mx-auto">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-2 border border-green-200 rounded-md focus:outline-none focus:ring-2 focus:ring-green-300"
                    />
                  </div>
                  <div>
                    <label className="block text-green-800 font-medium mb-1">
