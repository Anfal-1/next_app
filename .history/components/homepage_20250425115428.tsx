        ...
        <section className="bg-white py-16 px-6">
          <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
            ...
            <div className="lg:w-1/2 flex justify-center relative">
              ...
              {/* الإطار العلوي يمين */}
              <div className="absolute -top-4 -right-4 w-64 h-64 border-1 border-amber-800 rounded z-0"></div>
              {/* الإطار السفلي يسار */}
              <div className="absolute -bottom-4 -left-4 w-64 h-64 border-1 border-amber-800 rounded  z-0"></div>{' '}
              {/* الصورة */}
              <Image
