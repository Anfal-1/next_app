        ...
        <section className="bg-white py-16 px-6">
          <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
            ...
            <div className="lg:w-1/2 flex justify-center relative">
              ...
              {/* الإطار العلوي يمين */}
              <div className="absolute -top-1  -right-4 w-60 h-60 border-2 border-amber-800 rounded z-0"></div>
              {/* الإطار السفلي يسار */}
              <div className="absolute -bottom-1 -left-4 w-60 h-60 border-2 border-amber-800 rounded  z-0"></div>{' '}
              {/* الصورة */}
              <Image
