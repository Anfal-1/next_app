      ...
      <main className="flex-1">
        <section className="relative h-screen flex items-center justify-center bg-gradient-to-l from-white to-green-100 px-4">
          <div className="max-w-2xl text-center space-y-10 animate-fade-in">
            <h1
              className="text-4xl md:text-5xl font-bold leading-snug text-transparent bg-clip-text bg-gradient-to-r from-white to-green-300"
              style={{ textShadow: '0 1px 2px rgba(0,0,0,0.05)' }}
            >
              {t('home.hero.title')}
            </h1>

            <p className="text-transparent bg-clip-text bg-gradient-to-r from-white to-green-300">
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              <Button
                asChild
                size="lg"
                className="bg-white text-green-800 border border-green-100 hover:bg-green-50 transition duration-300"
              >
