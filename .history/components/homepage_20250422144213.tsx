            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="mb-8 text-green-100">
                  نحن دائماً نبحث عن شركاء ومتطوعين جدد للانضمام إلى مبادراتنا
                  البيئية. سواء كنت فرداً أو مؤسسة، يمكنك المساهمة في بناء
                  مستقبل أكثر استدامة.
                </p>
              ...
              <div>
                <form className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-green-500 hover:bg-green-400 text-white font-medium py-2 px-4 rounded-lg transition-colors"
                  >
                    إرسال الرسالة
                  </button>
                </form>
