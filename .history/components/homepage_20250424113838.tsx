              ...
              <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-green-800 mb-4">
                    {t('features.inviteTitle')}
                  </h2>
                  <p className="text-lg leading-relaxed text-gray-700">
                    {t('features.inviteDescription')}
                  </p>
                </div>
                ...
                <form className="bg-white rounded-lg p-6 shadow-md space-y-4">
                  <label className="block text-sm font-medium text-gray-700">
                    {t('features.messageLabel')}
                  </label>
                  <textarea
                    rows={4}
                    className="w-full border border-green-300 rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-green-600"
                  />
                  <button
                    type="submit"
