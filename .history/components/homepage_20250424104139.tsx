  ...
  return (
    <div className="flex min-h-screen flex-col bg-green-50 dark:bg-gray-900">
      ...
      <main className="flex-1">
        <section className="relative h-screen bg-green-50 flex items-center justify-center px-4">
          <div className="max-w-3xl text-center z-10">
            <h1 className="text-4xl md:text-5xl font-bold text-green-900 mb-8">
              {t('home.hero.title')}
            </h1>

            {/* صندوق محادثة وهمي مع AI */}
            <div className="bg-white border border-green-200 shadow-lg rounded-xl p-6 text-left space-y-4 max-w-xl mx-auto mb-8">
              <div>
                <p className="font-semibold text-gray-700">User:</p>
                <p className="text-gray-800">
                  What's the vegetation status in Al-Qassim today?
                </p>
              </div>
              <div>
                <p className="font-semibold text-green-700">E-Trek AI:</p>
                <p className="text-green-800">
                  The NDVI index is stable at{' '}
                  <span className="font-semibold">0.61</span>, indicating
                  healthy vegetation in most areas of Al-Qassim. Slight drop
                  detected near Buraydah.
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              <Button
                asChild
                size="lg"
                className="bg-green-700 text-white hover:bg-green-800 transition"
              >
              ...
              <Button
                asChild
                size="lg"
                className="bg-white text-green-800 border border-green-700 hover:bg-green-100 transition"
              >
