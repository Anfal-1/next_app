...
const translations = {
  ar: {
    ...
    'home.cta.description':
      'استكشف لوحة معلومات إي-تريك واكتشف كيف يمكن للبيانات البيئية المتقدمة أن تساعد في اتخاذ قرارات أفضل.',
  ...
  en: {
    ...
    q2: {
      question: 'How does the project support national goals like Vision 2030?',
      answer:
    ...
    q3: {
      question: 'Has the project been tested in practice?',
      answer:
    ...
    q4: {
      question: 'How can government entities use the platform?',
      answer:
    ...
    q5: {
      question: 'What data sources does E-Trek rely on?',
      answer:
    ...
    q7: {
      question: 'Is the platform scalable and secure?',
      answer:
    ...
    q8: {
      question: 'Can indicators or dashboards be customized?',
      answer:
    ...
    q9: {
      question: 'How can entities contribute or integrate with E-Trek?',
      answer:
    ...
    q10: {
      question: 'What is the real-world value of the platform?',
      answer:
