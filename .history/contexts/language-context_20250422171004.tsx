...
const translations = {
  ar: {
    ...
    // Footer
    'footer.description':
      'منصة متكاملة لمراقبة وتحليل البيانات البيئية في منطقة القصيم.',
  ...
  en: {
    ...
    'home.hero.subtitle':
      'An integrated platform for monitoring and analyzing environmental data , helping make sustainable decisions and protect natural resources.',
    ...
    'home.about.title':
      'How E-Trek Uses Artificial Intelligence to Combat Desertification',
    'home.about.description1':
      'Leverages AI to analyze satellite imagery and detect areas affected by desertification or vegetation loss.',
    'home.about.description2':
      'Uses machine learning and drone image processing to identify critical areas, generate reports, and support sustainable land management decisions.',
    'home.about.stats.area': 'km² analyzed',
    'home.about.stats.population': 'reports generated',
