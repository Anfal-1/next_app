...
const translations = {
  ar: {
    ...
    'home.hero.subtitle':
      'منصة متكاملة لمراقبة وتحليل البيانات البيئية، تساعد في اتخاذ قرارات مستدامة وحماية الموارد الطبيعية.',
    ...
    'home.cta.description':
      'استكشف لوحة معلومات إي-تريك واكتشف كيف يمكن للبيانات البيئية المتقدمة أن تساعد في اتخاذ قرارات أفضل وحماية البيئة.',
