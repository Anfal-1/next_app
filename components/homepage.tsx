...
import { ArrowRight, BarChart3, Globe, Leaf, MapPin, Shield } from "lucide-react"
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className={`${language === "ar" ? "md:order-2" : "md:order-1"}`}>
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">{t("home.hero.subtitle")}</p>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button asChild size="lg" variant="outline" className="border-green-200 dark:border-green-900">
                    <Link href="#features">{t("home.hero.learnMoreBtn")}</Link>
                  </Button>
                </div>
              </div>
              <div className={`${language === "ar" ? "md:order-1" : "md:order-2"} relative`}>
        ...
        <section id="features" className="py-20 bg-white dark:bg-gray-800">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-green-800 dark:text-green-400 mb-4">{t("home.features.title")}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <FeatureCard
                icon={<Globe className="h-10 w-10 text-green-600 dark:text-green-500" />}
              ...
              />
              <FeatureCard
                icon={<Shield className="h-10 w-10 text-green-600 dark:text-green-500" />}
                title={t("home.features.cards.risk.title")}
                description={t("home.features.cards.risk.description")}
              />
              <FeatureCard
                icon={<MapPin className="h-10 w-10 text-green-600 dark:text-green-500" />}
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className={`${language === "ar" ? "md:order-1" : "md:order-2"}`}>
                <h2 className="text-3xl font-bold text-green-800 dark:text-green-400 mb-6">{t("home.about.title")}</h2>
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">{t("home.about.description1")}</p>
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">{t("home.about.description2")}</p>
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                    <p className="text-3xl font-bold text-green-700 dark:text-green-500">28,200</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">{t("home.about.stats.area")}</p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                    <p className="text-3xl font-bold text-green-700 dark:text-green-500">1.5M+</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">{t("home.about.stats.population")}</p>
                  </div>
                </div>
              </div>
              <div className={`${language === "ar" ? "md:order-2" : "md:order-1"}`}>
        ...
        <section className="py-20 bg-green-700 dark:bg-green-800">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-green-100 max-w-3xl mx-auto mb-8">{t("home.cta.description")}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-green-800 dark:text-green-400">E-Trek</span>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-300">{t("footer.description")}</p>
            </div>

            <div>
              <h3 className="font-medium text-green-800 dark:text-green-400 mb-4">{t("footer.navigation")}</h3>
            ...
            <div>
              <h3 className="font-medium text-green-800 dark:text-green-400 mb-4">{t("footer.resources")}</h3>
              <ul className="space-y-2">
                <li>
                  <Link
                    href="#"
            ...
            <div>
              <h3 className="font-medium text-green-800 dark:text-green-400 mb-4">{t("footer.contact")}</h3>
              <ul className="space-y-2">
  ...
  return (
    <Card className="border-green-100 dark:border-gray-700">
      <CardHeader>
        ...
        <CardTitle className="text-xl text-green-800 dark:text-green-400">{title}</CardTitle>
      </CardHeader>
      <CardContent>
