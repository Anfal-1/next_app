...
export function SPIChart() {
  return (
    <div className="h-[400px] w-full">
      <div className="mb-4">
        <h3 className="text-lg font-semibold text-green-800">مؤشر هطول الأمطار القياسي (SPI)</h3>
      ...
      <ResponsiveContainer width="100%" height="80%">
        <BarChart data={spiData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke="#E8F5E9" />
          <XAxis dataKey="month" tick={{ fill: "#2E7D32" }} axisLine={{ stroke: "#C8E6C9" }} />
          <YAxis domain={[-2, 2]} tick={{ fill: "#2E7D32" }} axisLine={{ stroke: "#C8E6C9" }} />
          <Tooltip
            contentStyle={{
